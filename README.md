...
## Software Used
This two major software without which this project was impossible are Synopsys Custom Compiler and Synopsys Primewave. A huge thanks to the Synposys and IIT Hyderabad for providing the access to these elite softwares.
